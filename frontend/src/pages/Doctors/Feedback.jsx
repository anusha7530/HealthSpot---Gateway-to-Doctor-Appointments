      ...
      <div className='mb-[50px]'>
        ...
        <div className='flex justify-between gap-10 mb-[30px]'>
          <div className='flex gap-3'>
            ...
            <div>
              <h5 className='text-[16px] leading-6 text-primaryColor font-bold'>Mc Frak</h5>
              <p className='text-[14px] leading-6 text-textColor'>
                {formatDate("02-10-2023")}
              </p>
              <p className='text_para mt-3 font-medium text-[15px]'>Lorem ipsum dolor sit amet.</p>
            </div>
          </div>
